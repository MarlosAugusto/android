 ...
 */
package com.amperbackup.client.network
...
class ConnectivityServiceTest {
    ...
    internal abstract class Base {
        ...
        @Mock
        lateinit var accountManager: com.amperbackup.client.account.UserAccountManager

        @Mock
        lateinit var clientFactory: com.amperbackup.client.network.ClientFactory
        ...
        @Mock
        lateinit var requestBuilder: com.amperbackup.client.network.ConnectivityServiceImpl.GetRequestBuilder
        ...
        lateinit var connectivityService: com.amperbackup.client.network.ConnectivityServiceImpl

        @Before
        fun setUpMocks() {
            MockitoAnnotations.initMocks(this)
            connectivityService = com.amperbackup.client.network.ConnectivityServiceImpl(
