...
package com.amperbackup.client.device
...
class DeviceModule {
    ...
    @Provides
    fun powerManagementService(context: Context, preferences: com.amperbackup.client.preferences.AppPreferences): PowerManagementService {
